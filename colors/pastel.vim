"
" pastel - a vim theme for console and gvim
"
" Author: crater2150
"
" Loosely based on rdark (http://www.vim.org/scripts/script.php?script_id=1732)
"
...
if &background == "dark"
	...
	"--------------"
	" base colors:
	" Darker Blue:     39 #00afff
	" Lighter Blue:   111 #87afff
	" Orange:         215 #ffaf5f
	" Yellow:         221 #ffd75f
	" Green:          113 #87d75f
	...
	" Dark Red:       196 #ff0000
	" White:          255 #ffffff
	" Light Gray:     251 #c6c6c6
	" Dark Gray:      244 #8a8a8a
	"
	" UI ONLY
	" Backround Gray:     234 #1c1c1c
	" Lighter Background: 235 #262626
	" Visual Gray:        236 #303030
	" Black:     		0 #000000 (only for editor bg)
	...
	"{{{
	"runtime colors/pastellight.vim
