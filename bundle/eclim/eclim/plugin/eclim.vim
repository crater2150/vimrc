...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/crater2150/.eclipse/org.eclipse.platform_3.7.0_272132064/plugins/org.eclim_1.7.2'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/crater2150/.eclipse/org.eclipse.platform_3.7.0_272132064'
  if has('win32unix')
